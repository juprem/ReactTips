...
Vous pouvez voir mon linkedin ici : www.linkedin.com/in/olivier-abdelnour
...
Probablement dans les points les plus importants à respecter dans l'univers React, les ressources sont immutables (sauf à l'endroit où on les créer) et pour cela on peut passer par cette librairie [immer](https://immerjs.github.io/immer/)
...
- Ou un bon vieux sass [sass](https://sass-lang.com/install/)
